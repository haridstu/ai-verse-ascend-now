...
import { Play, BookOpen, Zap, Users, Star, ChevronRight, Brain, Code, Eye, MessageSquare } from "lucide-react";
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center">
          <div className="relative">
            ...
            <h1 className="relative text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-fade-in">
              Learn AI.
              <br />
              Build Tomorrow.
            </h1>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Learn AI. Build Tomorrow.</p>
            </div>
            <div>
